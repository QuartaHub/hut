...
<div id="filter_modal" class="modal">
    <?php
        $GLOBALS['novinkiPreFilter'] = ['PROPERTY_IS_NEW_VALUE' => 'Y'];
    ?>
    <?php $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            'CURRENCY_ID' => '',
            "SEF_MODE" => 'N',
            "SEF_RULE" => '/catalog/novinki/#SECTION_CODE_PATH#/filter/#SMART_FILTER_PATH#/apply/',
            "SMART_FILTER_PATH" => '',
            "PAGER_PARAMS_NAME" => '',
            "INSTANT_RELOAD" => '',
            "DISPLAY_ELEMENT_COUNT" => 'N',
            "PREFILTER_NAME" => "novinkiPreFilter",
        ),
        false,
        array('HIDE_ICONS' => 'Y')
    ); ?>
